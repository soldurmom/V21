...
Dashboard
          ...
          <li class="nav-item">
            <button class="nav-link" onclick="changeValue('orders')">
...
Orders
          ...
          <li class="nav-item">
            <button class="nav-link" onclick="changeValue('products')">
...
Products
          ...
          <li class="nav-item">
            <button class="nav-link" onclick="changeValue('users')">
...
Year-end sale
      ...
      <script>
          function changeValue(template){
              let data = { slider: template };
